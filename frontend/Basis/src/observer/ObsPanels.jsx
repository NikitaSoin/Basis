          ...
          <div className="obs-geomap-timeslider-banner">
            ...
            <div className="obs-geomap-timeslider-bannertext">
              ...
              <p className="obs-geomap-timeslider-caveat">
                Относится только к очагу СВО. История — по АРХИВНЫМ картам ISW (Institute for
                the Study of War): на каждый месяц берётся реальный срез оценённого контроля
                территории на ту дату, включая обратные движения — уход из-под Киева весной
                2022, Харьковскую область и правобережье Херсона осенью 2022. Положение
                «сегодня» (крайнее правое): линия — живая, с поправками по свежим данным
                МО РФ/Рыбаря; ряд площадей и дельты при этом считаются по единой методике
                чистого ISW для всех месяцев — иначе в последнюю дельту попадала бы разница
                методик (~2 тыс. км²), а не движение фронта. За февраль 2025 и июнь 2026 архивного среза у ISW нет — показан
                предыдущий месяц.
              </p>
            </div>
          </div>
          ...
          {sortedIsochroneMonths.length > 1 && (
            <div className="obs-geomap-isochart-block">
              ...
              <p className="obs-geomap-isochart-caveat">
                ...
                слева, не на глаз по высоте. Данные — архивные помесячные срезы карт ISW; оценка
                контроля на севере весной 2022 у ISW консервативна (коридоры снабжения, а не
                сплошные зоны), поэтому провал апреля 2022 (−12,8 тыс. км²) ниже сторонних оценок
                ухода с севера (20–30 тыс. км²). За февраль 2025 и июнь 2026 архивного среза нет —
                дельта за них нулевая, изменение попадает в следующий месяц.
              </p>
            </div>
          )}
        </div>
