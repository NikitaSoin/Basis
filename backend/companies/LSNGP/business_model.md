...
(строка ниже НЕ обновлена на 2025 год — требует перепроверки по годовому
отчёту). Чистая прибыль 2025 года по МСФО, по суждению аналитика (data_flags),
включает вероятный разовый эффект — нормализованная оценка ниже отчётной.
**Оценка, требует сверки с годовым отчётом.*
