...
_NEWS_REPORT_DETECT_RE = re.compile(
    r"отчита|отч[её]тност[а-я]{0,2}|"
    r"финансов[а-я]{0,3}\s+результат[а-я]{0,3}|операционн[а-я]{0,3}\s+результат[а-я]{0,3}|"
    r"результат[а-я]{0,3}\s+(?:за|по)\s|"
    r"мсфо|рсбу|чист[а-я]{0,3}\s+прибыл[а-я]{0,3}|чист[а-я]{0,3}\s+убыт[а-я]{0,3}|ebitda",
    re.IGNORECASE)
