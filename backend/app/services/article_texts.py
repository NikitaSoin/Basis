...
_TIMEOUT = 25
# Потолок на документ: рекордные бюллетени ЦБ бывают на сотни тысяч знаков, а ценность
# несёт начало (резюме, выводы). 60k знаков ≈ 27k токенов — при окне 1M это не давит.
_MAX_CHARS = 60_000
