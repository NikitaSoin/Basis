...
_OUTPUT_SPEC = (
    ...
    "B1. ТАРИФЫ И РЕГУЛИРУЕМЫЕ ЦЕНЫ. 🔴 В наших данных параметров индексации НЕТ (ни "
    "в календаре, ни в рядах). Поэтому: либо называешь конкретику из ПРОЧИТАННЫХ "
    "источников («индексация ЖКХ с 1 октября на X% по решению правительства»), либо НЕ "
    "используешь тарифы как драйвер с числом — вместо этого одной строкой в data_flags: "
    "«параметры осенней индексации тарифов в наших данных отсутствуют». Обезличенное "
    "«индексация тарифов осенью добавит 0,3-0,5 п.п.» ЗАПРЕЩЕНО: числа взяты из ниоткуда, "
    "а читателю не за что зацепиться.\n"
