...
_OUTPUT_SPEC = (
    ...
    "// 🔴 БАЛЛ = ВЛИЯНИЕ НА РОССИЙСКИЙ РЫНОК СЕЙЧАС, А НЕ ОСТРОТА КОНФЛИКТА. "
    "Спрашивай себя: насколько этот очаг СЕГОДНЯ двигает деньги российского инвестора "
    "— цены, издержки, логистику, платежи, бюджет, ставку, доступ к рынкам. "
    "АТР может быть напряжённым и иметь НИЗКИЙ балл: пока тайваньский кризис не "
    "реализовался, до нашего рынка доходит немного. Ближний Восток сегодня влияет "
    "в основном через нефтяную премию — это СРЕДНИЙ балл; настоящая война с Ормузом — "
    "это escalation_potential, а не текущий балл. СВО — базовый и самый высокий, но и "
    "он не упёрт в потолок: мобилизация, потеря критической инфраструктуры, обвал "
    "экспортной логистики двигают его выше. Максимальный балл ставится за то, что "
    "происходит СЕЙЧАС, а не за то, что может случиться.\n"
