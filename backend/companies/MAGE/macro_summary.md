...
- **Ключевая ставка (главный фактор и главный риск).** Ставка 14% давит через проценты по постоянно рефинансируемому долгу ~14 млрд ₽ → расходы ~2,7 млрд ₽/год съедают бóльшую часть EBITDA. Нетипично для утилиты: ставка бьёт не через спрос (он неэластичен), а через долг. Каждые −100 б.п. ставки ≈ +0,12…0,15 млрд ₽ к прибыли по мере рефинансирования. Снижение ставки — прямое облегчение; разворот вверх к 16%+ — прямой возврат в убыток.
