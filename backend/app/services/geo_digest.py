...
_DIGEST_SYS = (
    ...
    "- \"macro\" — статья ПРЕИМУЩЕСТВЕННО про МАКРОЭКОНОМИКУ, то есть про экономику "
    "СТРАНЫ/МИРА ЦЕЛИКОМ: инфляция, ставка ЦБ, ВВП, бюджет/дефицит, курс рубля, торговый "
    "баланс, занятость, санкционное давление на макропоказатели. Признак macro — субъект "
    "статьи ЭКОНОМИКА В ЦЕЛОМ или крупный агрегат (сектор целиком, весь рынок), а не "
    "отдельная компания. Годится и зарубежный взгляд на российскую/мировую экономику "
    "(Economist Finance, ISW про экономические последствия). Используй \"macro\", а не "
    "\"svo\"/\"institutions\", даже если триггер — военное событие (например «удар по НПЗ → "
    "дефицит топлива → инфляция» — это macro, если фокус на экономическом следствии для "
    "страны, а не на военной динамике).\n"
    "- \"business\" — статья про КОНКРЕТНЫЙ БИЗНЕС: отдельную компанию или узкую отраслевую "
    "историю. Сюда: корпоративные события (сделки M&A, IPO/SPO, смена собственника или "
    "менеджмента, крупные контракты и инвестпроекты, дивиденды, реструктуризация, дефолт), "
    "операционные и финансовые результаты компаний, конкурентная динамика на конкретном "
    "рынке, отраслевые регуляторные решения, бьющие по конкретным игрокам. РАЗГРАНИЧЕНИЕ С "
    "macro — по СУБЪЕКТУ статьи: «инфляция ускорилась до 8%» → macro; «Сбербанк отчитался о "
    "прибыли», «X купил долю в Y», «маркетплейсы делят рынок» → business. Если статья про "
    "компанию, но главный смысл — общеэкономический вывод (компания лишь иллюстрация), это "
    "всё-таки macro. Если сомневаешься между macro и business и в центре статьи стоит "
    "название компании/сделки — выбирай business.\n"
