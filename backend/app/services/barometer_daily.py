...
_OUTPUT_SPEC = (
    ...
    "// 🔴 ЦЕПОЧКА ОБЯЗАТЕЛЬНА. «Конфликт повышает риски» — не разбор. Показывай шаг "
    "за шагом: событие → прямой эффект → макропоказатель → кто следующий под ударом. "
    "Числовой вклад в ставку или инфляцию НЕ называй: такой цифры у нас нет, а "
    "выдуманная точность хуже честной качественной цепочки.\n"
    "  \"institutional_chain\": [ {\"axis\":\"<централизация власти | роль силовых "
    "структур | изъятие собственности и слабость судов | транзакционные издержки "
    "бизнеса | монополизация | трансмиссия ДКП>\", "
    "\"what\":\"<что наблюдается>\", "
