...
const METRICS = {
  // dom снизу −100: с методикой Basis (BFV) потенциалы уходят до −98 % (медиана по рынку
  // −44 %), и прежняя нижняя граница −50 % отрезала бы половину бумаг от фильтра и
  // гистограммы — они просто не попадали бы в диапазон.
  upside:        { label: "Потенциал", unit: "%", dir: "high", dom: [-100, 150], dec: 0, group: "Оценка",
...
const PRESETS = [
  ...
  { id: "divcov", name: "Высокая дивдоходность", desc: "Дивдоходность ≥ 11%", ranges: { div_yield: [11, 18] } },
