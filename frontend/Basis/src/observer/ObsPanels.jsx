      ...
      <div className="obs-geomap-detail" role="region" aria-label="Детали исторической реконструкции линии фронта">
        ...
        <p className="obs-geomap-detail-desc">
          ...
          {capture.history_source === "live"
            ? ". Текущий месяц — живая линия с поправками по данным МО РФ/Рыбаря."
          ...
          <div className="obs-geomap-timeslider-banner">
            ...
            <div className="obs-geomap-timeslider-bannertext">
              ...
              <p className="obs-geomap-timeslider-caveat">
                ...
                «сегодня» (крайнее правое) — живая линия с поправками по свежим данным
                МО РФ/Рыбаря. За февраль 2025 и июнь 2026 архивного среза у ISW нет — показан
                предыдущий месяц.
              </p>
            </div>
          </div>
