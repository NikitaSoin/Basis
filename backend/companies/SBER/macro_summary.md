...
**1. Смягчение ключевой ставки — двусторонний фактор (факт: ставка 14%).**
...
**4. Замедление инфляции и форма кривой ОФЗ — снова смешанно (факт: инфляция ~5,94%, длинные ОФЗ ~14,9%).**
