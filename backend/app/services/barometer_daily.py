...
_OUTPUT_SPEC = (
    ...
    "  \"barometer\": {\"overall\": <1..5, шаг 0.5>, "
    "\"label\":\"<вердикт одной фразой ПРО ЭТОТ ОЧАГ>\", "
    "\"escalation_potential\": <1..5 — каким станет влияние, если очаг ЭСКАЛИРУЕТ>, "
    "\"escalation_note\":\"<что именно должно случиться, чтобы влияние выросло>\"}, "
