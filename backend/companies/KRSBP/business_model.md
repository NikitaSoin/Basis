...
Вывод из таблицы: выручка растёт двузначно (+14%), но прибыль в 2025-м снизилась
(−10% после пикового 2024-го). Прибыль делится между дивидендами KRSB и KRSBP по
приоритету, установленному уставом. При выплате KRSBP может получить повышенный
дивиденд (до 10% выше относительного размера). Полная финансовая модель компании
идентична KRSB; финансовые показатели в этой таблице отражают результат компании.
