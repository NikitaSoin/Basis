...
Финансовые якоря — те же, что у обыкновенных акций (один эмитент, одна
компания): первичные консолидированные МСФО-отчёты с сайта компании, сведены
в financials.json (МСФО, млн ₽). По консолидированной группе 2025-й убыточен;
при этом дивидендная база — РСБУ-прибыль головной компании (~600 млн ₽ за
2024-й), поэтому выплаты пока покрываются, но консолидированная экономика
этого не подтверждает. Как дивиденд распределяется между обыкновенными и
преф-акциями, компания не раскрывает отдельно — по факту дивидендные платежи
в последние годы соответствовали уставной схеме преф-дивидендов плюс остаток
обыкновенным.
