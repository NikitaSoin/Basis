...
предел ~400 знаков, длиннее отбраковывается целиком). Не захватывай абзац целиком
...
~400 знаков). Не захватывай в один find абзац целиком вместе с заголовком — такая
