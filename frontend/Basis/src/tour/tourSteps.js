...
//   company    → src/company/CompanyCardView.jsx (шапка карточки,
//                .cc-header-panel: цена, метрики, потенциал к справедливой,
//                эпистем-теги. 🔴 Раньше цель стояла на блоке «Справедливая
//                цена по методике Basis» — он рендерится только при
//                посчитанной BFV или непустых методах оценки, и шаг уходил
//                в «не нашли блок» даже на ROSN; проверено на бою)
...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: "Открыли разбор конкретной бумаги. В шапке — цена, ключевые метрики и потенциал к справедливой цене Basis; у каждого числа помечено, факт это, оценка или суждение. Ниже — восемь вкладок разбора: от бизнес-модели до геополитики.",
  },
  {
    id: "screener",
    action: "navigate",
