...
_KW_DIV_POLICY_NEG = ("полити", "приостанов", "отказал", "не будет платить",
                      "отмен", "не рекоменд", "прекращ выплат")
_KW_MA = ("поглощен", "слияни", "m&a", "приобрет", "выкуп доли", "продаж",
...
_KW_OWNERSHIP = ("сменила акционер", "сменил акционер", "сменился акционер",
                 ...
                 "приобрел контрольный пакет", "приобрела контрольный пакет",
                 "смена бенефициара", "смена владельца", "сменился владелец")
_KW_MGMT = ("совет директоров", "гендиректор", "генерального директора",
            "председател", "покинет пост", "уходит с поста", "сменил гендиректора",
            "новый генеральный директор", "новым генеральным директором")
