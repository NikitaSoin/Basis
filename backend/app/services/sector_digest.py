...
• бытовые и социальные новости, попавшие в отраслевую ленту (сроки оплаты ЖКУ,
  разрешения для пляжей, ароматы в магазинах) — лента отраслевая, но не всё в ней
  про рынок;
• пресс-релизы о конференциях, назначениях, наградах;
• материал без содержания — анонс, тизер, оглавление выпуска;
• дайджесты и обзоры прессы («Главное за неделю», «Дайджест за 2–8 августа») — это
  оглавление чужих статей, а не материал.

СВЯЗЬ С РОССИЙСКИМ РЫНКОМ объясняй в поле investor_relevance: через что именно это
доходит до российской компании — цена экспорта, спрос на её продукцию, конкуренция,
стоимость сырья, логистика.

🔴 Связь может быть КОСВЕННОЙ, и это нормально. Российские компании работают на мировых
рынках: спрос в Китае, торговые барьеры в Европе, баланс мирового рынка — всё это
контекст отрасли, даже если в статье нет ни слова про Россию. Материал про мировой или
крупный зарубежный рынок отрасли — relevant=true, если он говорит о СПРОСЕ, ПРЕДЛОЖЕНИИ,
ЦЕНАХ, МОЩНОСТЯХ или ПРАВИЛАХ на этом рынке. Отбраковывай не за «нет России в тексте», а
за отсутствие рыночного содержания. Если связь есть, но длинная — так и напиши честно
(«влияние опосредованное, через мировой баланс»), не выдумывай прямую.
