...
# ОПОРНЫЕ ПУНКТЫ ДО ФЕВРАЛЯ 2022 — критично для реконструкции.
# Наши датасеты описывают захваты 2022+; ядро Донбасса, удерживаемое с 2014
# года, в них НЕ представлено НИ ОДНОЙ точкой. Из-за этого восточный Донбасс
# попадал в ячейку Вороного какого-нибудь пункта, взятого в 2024-м, и на
# реконструкции годами оставался НЕЗАКРАШЕННЫМ — та самая «пустота в ЛНР/ДНР»
# (владелец, 2026-07-25; замерено: 2950 км² держались с 2022 по 2024 год).
# Тот же эффект, что уже ловили с Крымом. Даты — факт, не оценка: эти города
# под контролем ДНР/ЛНР с 2014 года (Дебальцево — с февраля 2015).
# Плюс несколько пунктов северного Присивашья: заняты в первые сутки
# 24.02.2022, но в датасете отсутствуют, оставляя пустоту у Крымского перешейка.
BASELINE_PRE_2022 = [
    # ядро ДНР (2014)
    ("Донецк", "Donetsk", "Донецкая", "2014-04-07"),
    ("Макеевка", "Makiivka", "Донецкая", "2014-04-13"),
    ("Горловка", "Horlivka", "Донецкая", "2014-04-14"),
    ("Енакиево", "Yenakiieve", "Донецкая", "2014-04-13"),
    ("Харцызск", "Khartsyzk", "Донецкая", "2014-04-13"),
    ("Шахтёрск", "Shakhtarsk", "Донецкая", "2014-04-16"),
    ("Торез", "Torez", "Донецкая", "2014-04-16"),
    ("Снежное", "Snizhne", "Донецкая", "2014-04-13"),
    ("Ждановка", "Zhdanivka", "Донецкая", "2014-04-16"),
    ("Кировское", "Kirovske", "Донецкая", "2014-04-16"),
    ("Новоазовск", "Novoazovsk", "Донецкая", "2014-08-27"),
    ("Дебальцево", "Debaltseve", "Донецкая", "2015-02-18"),
    # ядро ЛНР (2014)
    ("Луганск", "Luhansk", "Луганская", "2014-04-27"),
    ("Алчевск", "Alchevsk", "Луганская", "2014-05-01"),
    ("Стаханов", "Kadiivka", "Луганская", "2014-04-30"),
    ("Брянка", "Brianka", "Луганская", "2014-04-30"),
    ("Первомайск", "Pervomaisk", "Луганская", "2014-05-01"),
    ("Красный Луч", "Khrustalnyi", "Луганская", "2014-04-30"),
    ("Ровеньки", "Rovenky", "Луганская", "2014-04-30"),
    ("Антрацит", "Antratsyt", "Луганская", "2014-04-30"),
    ("Свердловск", "Dovzhansk", "Луганская", "2014-04-30"),
    ("Краснодон", "Sorokyne", "Луганская", "2014-04-29"),
    ("Перевальск", "Perevalsk", "Луганская", "2014-05-01"),
    ("Кировск", "Holubivka", "Луганская", "2014-04-30"),
    # северное Присивашье — занято в первые сутки 24.02.2022
    ("Чаплинка", "Chaplynka", "Херсонская", "2022-02-24"),
    ("Каланчак", "Kalanchak", "Херсонская", "2022-02-24"),
    ("Новотроицкое", "Novotroitske", "Херсонская", "2022-02-24"),
    # ЛЕВОБЕРЕЖЬЕ ХЕРСОНЩИНЫ И ПРИАЗОВЬЕ — заняты в первые дни и удерживаются
    # до сих пор; без них низовья Днепра и юг Запорожья остаются пустыми.
    ("Новая Каховка", "Nova Kakhovka", "Херсонская", "2022-02-24"),
    ("Алёшки", "Oleshky", "Херсонская", "2022-02-24"),
    ("Голая Пристань", "Hola Prystan", "Херсонская", "2022-02-25"),
    ("Скадовск", "Skadovsk", "Херсонская", "2022-02-25"),
    ("Геническ", "Henichesk", "Херсонская", "2022-02-24"),
    ("Мелитополь", "Melitopol", "Запорожская", "2022-03-01"),
    ("Бердянск", "Berdiansk", "Запорожская", "2022-02-27"),
    ("Токмак", "Tokmak", "Запорожская", "2022-02-26"),
    ("Энергодар", "Enerhodar", "Запорожская", "2022-03-04"),
    ("Васильевка", "Vasylivka", "Запорожская", "2022-03-02"),
    # КОЛЬЦО ВОКРУГ МАРИУПОЛЯ. Владелец (2026-07-25): «Мариуполь когда
    # захватывали — вокруг всё было взято, сам населённый пункт оставался
    # какое-то время не под контролем». Без этих точек ячейка Вороного самого
    # Мариуполя накрывала всю округу и до мая-2022 держала её незакрашенной —
    # ровно наоборот к тому, как было. Даты — выход к городу и блокирование.
    ("Волноваха", "Volnovakha", "Донецкая", "2022-03-12"),
    ("Мангуш", "Manhush", "Донецкая", "2022-03-01"),
    ("Никольское", "Nikolske", "Донецкая", "2022-03-05"),
    ("Сартана", "Sartana", "Донецкая", "2022-03-08"),
    ("Талаковка", "Talakivka", "Донецкая", "2022-03-05"),
    ("Виноградное", "Vynohradne", "Донецкая", "2022-03-05"),
    ("Широкино", "Shyrokyne", "Донецкая", "2022-02-28"),
]
...
def main() -> int:
    ...
    # Опорные пункты 2014-го и первых суток 2022-го — идут ПЕРЕД таблицей, их
    # переходы сольются с более поздними, если пункт встретится и там.
    for name, name_lat, oblast, when in BASELINE_PRE_2022:
        points.insert(0, {"name": name, "name_lat": name_lat, "oblast": oblast,
                          "date": when, "holder": "RF", "precision": "день",
                          "source": "опорный пункт до 02.2022", "is_aggregate": False})
    ...
    # ВЫВОД ПО ЛОГИКЕ: нельзя освободить то, что не было занято. Если самый
    # ранний известный переход пункта — освобождение Украиной, значит РФ его до
    # этого держала, просто дата взятия в источники не попала. Без этого вывода
    # весь север кампании 2022 (Киевская/Черниговская/Сумская) и правобережье
    # Херсонщины числились украинскими ВСЕГДА — на реконструкции их не было
    # вовсе (владелец, 2026-07-25: «надо восстановить хронологию февраля/марта
    # 2022... сейчас либо ничего либо какие-то дурости»).
    WAR_START = "2022-02-24"
    inferred = 0
    for entry in by_settlement.values():
        entry["transitions"].sort(key=lambda t: t["date"])
        first = entry["transitions"][0]
        if first["holder"] == "UA" and first["date"] > WAR_START:
            entry["transitions"].insert(0, {
                "date": WAR_START, "holder": "RF", "precision": "оценка",
                "source": "вывод: освобождён позже, значит был занят с начала",
            })
            inferred += 1
    print(f"выведено начальных переходов к РФ (по факту последующего освобождения): {inferred}")
