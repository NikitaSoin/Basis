...
## Снимок (июль 2026)
- **Ставка 14%, снижается (решение от 24.07.2026)** — для закредитованной компании вектор ВНИЗ это главный среднесрочный позитив (ослабнут проценты + упадёт WACC).
- **Инфляция 5,94%, снижается.** Продовольственная инфляция выше общей — поддерживает рублёвую выручку, НО цены на соцпродукты под ФАС, а спрос слабый → в маржу транслируется не полностью.
