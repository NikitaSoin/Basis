...
_OUTPUT_SPEC = (
    ...
    "B1. ТАРИФЫ И РЕГУЛИРУЕМЫЕ ЦЕНЫ называй КОНКРЕТНО: какие именно (ЖКХ, газ, "
    "электроэнергия, ж/д перевозки), с какой даты и на сколько процентов. «Индексация "
    "тарифов осенью» без расшифровки не даёт читателю ничего.\n"
