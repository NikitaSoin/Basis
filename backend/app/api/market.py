...
def _inst_anonymize(payload: dict) -> dict:
    ...
    def _has_person(t: str) -> bool:
        t = t or ""
        # Основной шаблон — типичные окончания русских фамилий. Плюс
        # множественное число («Патрушевы», «Ротенберги») — так пишут про
        # семейные группы, и первый шаблон их пропускал: окончание уже не «ов».
